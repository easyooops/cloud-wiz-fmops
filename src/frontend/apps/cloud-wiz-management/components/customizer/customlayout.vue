    ...
    <ul class="sidebar-type layout-grid layout-types">
      ...
      <li data-attr="material-layout horizontal-wrapper">
        <div class="layout-img">
          ...
          ">
          <img src="/images/landing/layout-images/los-angle.png" class="img-fluid" alt="one" />
          </a>
      ...
      <li class="only-body" data-attr="default-body">
        <div class="layout-img">
          <a @click="handlePageLayputs('only-body', 'London')"><img src="/images/landing/layout-images/london.png"
              class="img-fluid" alt="one" /></a>
